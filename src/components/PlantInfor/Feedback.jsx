...
const reviews = [
  { name: 'Emily Johnson', review: 'Herbal Garden transformed our inventory management, making it efficient and hassle-free!', avatarImg: Man1, ratingvalue: 4.5 },
  { name: 'Michael Brown', review: 'The analytics and real-time updates provided by Herbal Garden are exceptional and have significantly boosted our productivity.', avatarImg: Man2, ratingvalue: 4 },
  { name: 'Sarah Wilson', review: 'Highly recommend Herbal Garden for any business looking to optimize their stock levels and reduce waste.', avatarImg: Man3, ratingvalue: 4.5 },
  { name: 'David Lee', review: 'With Herbal Garden, our stockouts have drastically reduced, and our operations are running smoother than ever!', avatarImg: Man4, ratingvalue: 5 },
];
